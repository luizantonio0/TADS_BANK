...
export const routes: Routes = [
  ...
  { path: 'cliente', component: InicialCliente, title: 'TADS BANK | Área do cliente', canActivate: [clienteGuard] },
  { path: 'gerente', component: InicialGerente, title: 'TADS BANK | Área do gerente', canActivate: [clienteGuard] },
  { path: 'administrador', component: InicialAdministrador, title: 'TADS BANK | Área do administrador', canActivate: [clienteGuard]}
];
